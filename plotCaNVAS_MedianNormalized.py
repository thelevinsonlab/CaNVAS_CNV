...
def createPlots(outputpath):
	...
	for f in files:
		...
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutLeft", row=2, col=1)
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutLeft", row=2, col=2)
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutLeft", row=2, col=3)
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutRight", row=3, col=1)
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutRight", row=3, col=2)
		fig.update_xaxes(title_text="MedianLRRIn-MedianLRROutRight", row=3, col=3)
		fig.update_yaxes(title_text="MedianLRRIn", row=1, col=1)
		fig.update_yaxes(title_text="MedianLRROutLeft", row=1, col=1)
		fig.update_yaxes(title_text="MedianLRROutRight", row=1, col=1)
